...
<div class="container-fluid" style="border-bottom: #d9d9d9 solid 2px">
        ...
        <div class="circle">
            <a href="index.php?content=bayar&zoner=rekappembayaran">
                <img src="../img/history.png" width="80%" style="margin: auto"/>

            </a>

            <p><h4>Rekapitulasi</h4></p>

        </div>

        <div class="circle">

            <a href="index.php?content=bayar&zoner=pembayarannow">
        ...
        <div class="circle">
            ...
            <a href="index.php?content=bayar&zoner=pembayarannext">
                <img src="../img/future.png" width="80%" style="margin: auto"/>

            </a>

            <p><h4>Selanjutnya</h4></p>
