...
<form class="form-horizontal" id="register" method='post' action='bioupdate.php' name='forme' enctype="multipart/form-data">
...
<div class="control-group">
    ...
    <div class="controls">
        ...
        $qsiswa="select * from info_biodata where NIS='$row[NIS]'";
...
<div class="control-group">
    ...
    <div class="controls">
        <input type="text" class="input-medium" id="tempat" name="tempat" value="<?php echo $rowsiswa['Tmplahir']?>">,
        <input type="text" class="input-small" id="tanggal" name="tgl" value="<?php echo $rowsiswa['TglLahir']?>">
...
<div class="control-group">
    ...
    <div class="controls">
        <input type="text" class="input-large" id="sekolah" name="sekolah" value="<?php echo $rowsiswa['Sekolah']?>">
...
<div class="control-group">
    ...
    <div class="controls">
        <input type="text" class="input-medium" id="noijasah" name="noijasah" value="<?php echo $rowsiswa['NoIjasah']?>">
...
<div class="control-group">
    ...
    <div class="controls">
        <input type="text" class="input-medium" id="noskhun" name="noskhun" value="<?php echo $rowsiswa['NoSKHUN']?>">
...
<div class="control-group">
    ...
    <div class="controls">
        <input type="text" class="input-medium" id="status" name="status" value="<?php echo $rowsiswa['Status']?>">
...
<div class="control-group">
    ...
    <div class="controls">
        <input type="text" class="input-medium" id="tlp" name="tlp" value="<?php echo $rowsiswa['NoTelp']?>">
...
<div class="control-group">
    ...
    <div class="controls">
        <input type="text" id="nmwali" name="nmwali" value="<?php echo $rowsiswa['NmWali']?>">
...
<div class="control-group">
    ...
    <div class="controls">
        <input type="text" class="input-medium" id="tlpwali" name="tlpwali" value="<?php echo $rowsiswa['NoTelpWali']?>">
...
<div class="control-group">
    ...
    <div class="controls">
        <button type="submit" class="btn btn-info" rel="tooltip" title="Update">UBAH</button>
