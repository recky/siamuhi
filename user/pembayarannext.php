...
<center><h3>Pembayaran Selanjutnya</h3></center>
<table width="100%" class="table">
    <tr align="center" style="background: #0074c7;">
        ...
        <th width=""><strong><p align="center">Biaya</strong></th>
        <th width=""><strong></strong></th>
    ...
    $query="Select * from info_bayar,ta,info_form where info_bayar.ta=ta.ta and info_form.nis=info_bayar.nis and info_form.iduser='$id' and info_bayar.status=0 and ta.status=1";
    ...
    while($row=mysql_fetch_array($hasil))
    {
        ...
        echo"<tr><td>$row[jenis]$row[kelas]$row[notrans]</font></td>".
            ...
            "<td>$row[ta]</td>".
            "<td><p align='center'>BELUM</p></td></tr>";
