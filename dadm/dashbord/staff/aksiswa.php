            ...
            if($_GET['jml']==''){
                ?>
                  <div class="well">
                    ...
                    <h3 style="text-align: center">Input Login Siswa</h3>
                <form class="form-horizontal" method='post' action='../dashbord/staff/inaksiswa.php' enctype="multipart/form-data">
                    ...
                    <div style="margin: auto;width: 35%;border: 2px solid #c0c0c0;padding: 2%;float:left">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" class="input-xlarge" name="nis" placeholder="Wajib diisi..."/>
                            </div>
                        </div>
                        <div class="control-group">
                            <div class="control">
                    ...
                    <form class="form-horizontal" method='get' action='index.php?' enctype="multipart/form-data">
                        ...
                        <div style="margin: auto;width: 35%;border: 2px solid #c0c0c0;padding: 2%;float:right;">
                            ...
                            <div class="control-group">
                                <input type="text" name="content" value="aksiswa" class="hidden"/>
                            ...
                            <div class="control-group">
                                <div class="control">
                                    <button type="submit" class="btn btn-primary input-xlarge"><i class="icon-check"></i>PROSES</button>
                                </div>
                            </div>
                        ...
                        <?php }else{?>
                    <form class="form-horizontal" method='post' action='../dashbord/staff/inaksiswaby.php' enctype="multipart/form-data">
                          ...
                          <input type="text" class="hidden" name="jumlah" value="<?php echo $_GET['jml'];?>"/>
                            ...
                            <div class="control-group">
                                <div class="control">
                                    ...
                                    <a href="index.php?content=aksiswa" class="btn btn-danger input-xlarge"><i class="icon-off"></i>BATAL</a>
                                </div>
                            </div>
                    </form>
                        <?php }?>
