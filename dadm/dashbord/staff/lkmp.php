...
<table width="100%" class="table table-bordered table-striped">
    ...
    $qsnik="select * from kategori order by IdKategori asc limit $posisi,$batas";
    ...
    while($row=mysql_fetch_array($hasil))
    {
        ...
        echo"<a href='?content=kmp&id=$row[IdKategori]&edit=1' class='btn btn-xs btn-primary' title='Edit'><i class='icon-pencil'></i></a> </td></tr>";
