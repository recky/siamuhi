...
<script type="text/javascript">
    ...
    function cari(){
        $('#key').change(function(){
            ...
            var key =$("#key").val();
            //alert($("#ThnAjar").val());
            window.location="index.php?content=abklsxi&key="+key;
        });
    }
</script>
    <?php
...
<form method="post" action="../dashbord/guru/inproab.php" enctype="multipart/form-data">
    ...
    <table width="100%" class="table table-bordered table-striped">
        ...
        </td><td><a href="?content=abklsxi&mod=l" class="btn btn-success"><i class="icon-zoom-in"></i>Lihat</a></td></tr>
